            ...
            <div className="flex justify-between items-center max-w-7xl mx-auto px-4 py-6 sm:px-6 md:justify-start md:space-x-10 lg:px-8">
              <div className="flex justify-start lg:w-0 lg:flex-1">
                <a href="#">
                  ...
                  <img className="h-8 w-auto sm:h-10" src="https://scontent.ftun9-1.fna.fbcdn.net/v/t1.6435-9/118040038_1849462388527056_8523756619276723267_n.jpg?_nc_cat=107&ccb=1-7&_nc_sid=e3f864&_nc_ohc=76y_gyzwoWsAX8QpK_D&_nc_ht=scontent.ftun9-1.fna&oh=00_AfCtL8y8PI0OeZe-OO1J7XSNWtAD9ZcUY9Qk6-joqpTcWQ&oe=64C86697" alt=""/>
                </a>
              </div>
              ...
              <nav className="hidden md:flex space-x-10">
                <div className="relative">
                 ...
                 {/*  <!--
                  ...
                  --> */}
                  {/* ////////////////////////////////////////////Expanded Box for solution */}
                
                </div>
      
                <a href="#" className="text-base font-medium text-gray-500 hover:text-gray-900"> Les prix </a>
      
                <a href="#" className="text-base font-medium text-gray-500 hover:text-gray-900"> Nos partenaires </a>
      
                <a href="#" className="text-base font-medium text-gray-500 hover:text-gray-900"> Les événements </a>
              </nav>
              <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
                <a href="#" className="whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-900"> Se Connecter </a>
                <a href="#" className="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700"> S'inscrire </a>
              </div>
            </div>
              ...
              <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div className="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
                  <div className="absolute inset-0">
                    <img className="h-full w-full object-cover" src="https://scontent.ftun9-1.fna.fbcdn.net/v/t39.30808-6/274002553_2318289654977658_4668604139069466943_n.jpg?_nc_cat=108&ccb=1-7&_nc_sid=e3f864&_nc_ohc=WaZpJ2Ejt9EAX9lmIO3&_nc_ht=scontent.ftun9-1.fna&oh=00_AfDTt1hNAksQgBC_i42fSLt_yKgH7vD7Vxa2wqbPqNzXoQ&oe=64A5AFF7" alt="People working on laptops"/>
                    <div className="absolute inset-0 bg-indigo-400 mix-blend-multiply"></div>
                  </div>
                  <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                    <h1 className="text-top text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl">
                      <span className="block text-white">Bienvenue à L'Horizon </span>
                      <span className="block  text-indigo-200"></span>
                    </h1>
                    <p className="mt-6 max-w-lg mx-auto text-center text-xl text-indigo-200 sm:max-w-3xl">Développez tout le potentiel de votre enfant dans notre prestigieuse école privée, où une éducation d'exception rencontre des opportunités illimitées de croissance et de réussite.</p>
                    <div className="mt-10 max-w-sm mx-auto sm:max-w-none sm:flex sm:justify-center">
                      <div className="space-y-4 sm:space-y-0 sm:mx-auto sm:inline-grid sm:grid-cols-1 sm:gap-5">
                        ...
                        {/* <a href="#" className="flex items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-indigo-500 bg-opacity-60 hover:bg-opacity-70 sm:px-8"> Live demo </a> */}
                      </div>
                    </div>
                  </div>
                </div>
